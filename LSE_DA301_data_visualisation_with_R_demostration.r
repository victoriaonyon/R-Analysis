...
# Add a further/third variable and no standard error (remove sharding bands)
ggplot(wages, aes(x=age, y=wage, col=job_class)) + 
  geom_point() + 
...
# Comparing age with wage and change the line width (lwd).
# Default lwd is 0.5
ggplot(wages, aes(x=age, y=wage, col=job_class)) + 
  geom_point() + 
